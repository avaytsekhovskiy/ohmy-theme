...
package ru.ohmy.theme.presentation.common.ext
...
fun <V : View> ViewBinder.bindView(id: Int)
        : ReadOnlyProperty<ViewBinder, V> = required(id, viewFinder)
...
fun <V : View> ViewBinder.bindOptionalView(id: Int)
        : ReadOnlyProperty<ViewBinder, V?> = optional(id, viewFinder)
...
fun <V : View> ViewBinder.bindViews(vararg ids: Int)
        : ReadOnlyProperty<ViewBinder, List<V>> = required(ids, viewFinder)
...
fun <V : View> ViewBinder.bindOptionalViews(vararg ids: Int)
        : ReadOnlyProperty<ViewBinder, List<V>> = optional(ids, viewFinder)
...
private val ViewBinder.viewFinder: ViewBinder.(Int) -> View?
